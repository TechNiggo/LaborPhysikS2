...
Wie in Tabelle \ref{tab:auswertung->zusammenfassung->vergleich} zu sehen, ist die Abweichung unserer Messwerte vom Literaturwert mit steigender Frequenz kleiner. Ein Grund dafür ist sehr wahrscheinlich die Wellenlänge, die mit steigender Frequenz kleiner wird. %somit das Ablesen mit einer geringeren Abweichung besser möglich ist. 
