...
Wie in Tabelle \ref{tab:auswertung->zusammenfassung->vergleich} zu sehen, fällt die Abweichung unserer Messwerte vom Literaturwert mit steigender Frequenz. Ein Grund dafür ist sehr wahrscheinlich an der Wellenlänge, die mit steigender Frequenz kleiner wird. %somit das Ablesen mit einer geringeren Abweichung besser möglich ist. 
